...
y_set = []
for i in range(336, 11919):
    y_set.append(values[i-16:i, 3])
...
X_train1=[]
for i in range(320,11903):
    X_train1.append(scaled[i-320:i,:])
X_train1 = np.array(X_train1)

y_train1 = []
for i in range(336, 11919):
    y_train1.append(scaled[i-16:i, 3])
...
#adding output layer
regressor.add(Dense(units=16,activation = 'linear'))
